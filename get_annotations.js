        ...
        if(layer['type'] == "annotation"){
            ...
            for( var annotation_idx in layer['annotations']){
                ...
                annotation_data.push(
                    ...
                    current_annotation["pointA"][0]*x_dims[0]/1e-9,
                    current_annotation["pointA"][1]*y_dims[0]/1e-9,
                    current_annotation["pointA"][2]*z_dims[0]/1e-9,
                    current_annotation["pointB"][0]*x_dims[0]/1e-9,
                    current_annotation["pointB"][1]*y_dims[0]/1e-9,
                    current_annotation["pointB"][2]*z_dims[0]/1e-9,
                ]
                );
            }
        }
